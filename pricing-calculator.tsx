      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Close More Deals Faster with Pro+
          </p>
        </div>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent className="max-w-xs">
                            <p>
                              ...
                              apply, but we don't add any markups.
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
              ...
              <div>
                  ...
                  <div className="flex justify-between mb-2">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          <p>
                            A completed sign is counted when your client
                            completes the entire signing process, including
                            document review, signature, and submission.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start">
                    <span className="text-gray-600 dark:text-gray-300">
                      <strong>Example:</strong> At 50 signs/month = $92.50/month
                      (just $1.85 per sign)
                    </span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-gray-600 dark:text-gray-300">
                      ...
                      $192.50/month (just $1.28 per sign)
                    </span>
                  </div>
                </div>
              </div>
