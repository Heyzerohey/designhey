...
import ClientListCard from "@/polymet/components/client-list-card";
import FirstLoginTipsModal from "@/polymet/components/first-login-tips-modal";
import {
  RECENT_CASES,
  UPCOMING_EVENTS,
  RECENT_DOCUMENTS,
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold tracking-tight">
            Welcome to Your Signhey Dashboard!
          </h1>
          <p className="text-muted-foreground">
            Let's Start Onboarding Clients
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <ClientListCard clients={RECENT_CLIENTS} />
      </div>
