...
import { ArrowLeftIcon, MailIcon, PhoneIcon, MapPinIcon } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Have questions about Signhey? We're here to help. Reach out to our
            ...
            <div className="lg:col-span-1 space-y-8">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <MailIcon className="h-5 w-5 text-orange-500 mt-0.5" />

                    <div>
                      <p className="font-medium">Email</p>
                      <a
                        href="mailto:support@signhey.com"
                  ...
                  <div className="flex items-start gap-3">
                    <PhoneIcon className="h-5 w-5 text-orange-500 mt-0.5" />
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    href="https://twitter.com/signhey"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-orange-100 dark:hover:bg-orange-900 transition-colors"
                  >
                    <svg
                      className="h-5 w-5"
                      fill="currentColor"
                  ...
                  <a
                    href="https://linkedin.com/company/signhey"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-orange-100 dark:hover:bg-orange-900 transition-colors"
                  >
                  ...
                  <a
                    href="https://facebook.com/signhey"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-orange-100 dark:hover:bg-orange-900 transition-colors"
                  >
