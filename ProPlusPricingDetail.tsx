...
export default function ProPlusPricingDetail() {
  ...
  return (
    <section id="pricing-detail" className="py-16 bg-gray-50 dark:bg-gray-900/50">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-4">
          Simple, Transparent Pro+ Pricing
        </h2>
        <p className="text-center text-gray-600 dark:text-gray-300 mb-12 max-w-xl mx-auto">
          Our Pro+ plan includes everything you need to streamline your client onboarding.
        </p>
